...
class KaReactorPhysics_Proxy(KaBase):
    ...
    def run_dakota_proxy(self):
        ...
        run_sfr_opt_mabs.run_dakota(self.weights, self.design_variables, self.objectives)
    ...
    def read_dakota_results(self):
        ...
        design_list = list(file['methods']['soga_{}'.format(ws_int)]['results']['execution:1']['best_parameters']['discrete_real'])
        obj_list = file['methods']['soga_{}'.format(ws_int)]['results']['execution:1']['best_objective_functions']
