...
class BbSfrOpt2D(blackboard.Blackboard):
    ...
    def on_init(self):
        ...
        self.objectives = {'reactivity swing': {'ll':0,   'ul':15000,  'goal':'lt', 'variable type': float},
    ...
    def plot_progress(self):
        ...
        if self.problem == 'prelims':
            ...
            if len(obj_dict.keys()) == 2:
                fig1 = px.scatter(x=obj_dict[objs[0]], y=obj_dict[objs[1]], color=pu_content, labels={'x':objs[0], 'y': objs[1], 'color': 'pu_content'})
