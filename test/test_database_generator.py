...
def test_dbg():
    ...
    assert out_obj == [(602.4030176530645, 435.742800668214, 1435.9608786299002, 858.7551867219967, 1.20837, 1.0, -0.45124404126092305, -60.34416518672346, 858.7551867219967, 0.0)]
    ...
    assert df_obj.equals(pd.DataFrame([(602.4030176530645, 435.742800668214, 1435.9608786299002, 858.7551867219967, 1.20837, 1.0, -0.45124404126092305, -60.34416518672346, 858.7551867219967, 0.0)], columns=objective_functions)) == True