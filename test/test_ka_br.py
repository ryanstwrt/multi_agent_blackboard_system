...
def test_kabr_interBB_init():
    ...
    assert br.get_attr('_entry') == None
    assert br.get_attr('_entry_name') == None
    assert br.get_attr('_writer_addr') == None
    assert br.get_attr('_writer_alias') == None
    assert br.get_attr('_executor_addr') == None
    assert br.get_attr('_executor_alias') == None
    assert br.get_attr('_trigger_response_addr') == None
    assert br.get_attr('_trigger_response_alias') == 'trigger_response_ka_br_inter'
    assert br.get_attr('_trigger_publish_addr') == None
    assert br.get_attr('_trigger_publish_alias') == None
    assert br.get_attr('_trigger_val') == 0
    assert br.get_attr('bb_lvl_read') == 1
    assert br.get_attr('_shutdown_addr') == None
    assert br.get_attr('_shutdown_alias') == None
    ...
    assert br.get_attr('_design_variables') == None
    assert br.get_attr('_objectives') == None
    assert br.get_attr('_constraints') == None
