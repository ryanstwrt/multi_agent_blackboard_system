...
def test_search_method_mixed():
    ...
    rp.search_method()
    assert list(bb.get_attr('abstract_lvls')['level 3']['new'].keys()) == ['core_[1.86,10.0,20.0]', 'core_[13.0,9.5,20.0]', 'core_[13.0,10.5,20.0]', 'core_[13.0,10.0,19.0]', 'core_[13.0,10.0,21.0]']
    assert [core for core in bb.get_attr('abstract_lvls')['level 3']['old'].keys()] == ['core_[13.0,250.0,25.0]']
